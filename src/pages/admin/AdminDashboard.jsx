    ...
    <AdminLayout>
      <div className="max-w-4xl">
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">Manage incoming print orders from students.</p>
        </div>

        {/* Stats */}
        <div className="grid grid-cols-3 gap-4 mb-8">
          {loading ? [1,2,3].map(i => <CardSkeleton key={i} />) : statCards.map(({ label, value, icon: Icon, color }) => (
        ...
        <div>
          ...
          {loading ? (
            ...
            <Card className="p-12 text-center">
              ...
              <p className="text-gray-400">No orders yet. Students will send orders to your shop.</p>
            </Card>
          ) : (
                  ...
                  <Card className="p-5 hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{order.student?.college} • {formatDate(order.createdAt)}</p>
                      </div>
